...
import { CalendarIcon, ClockIcon, SettingsIcon, Bars3Icon } from "@/components/Icons";

export type TabId = "today" | "timeline" | "settings" | "menu";
...
const TABS: { id: TabId; labelKey: string; Icon: React.FC<{ size?: number }> }[] = [
  { id: "today",    labelKey: "tabs.today",    Icon: CalendarIcon },
  { id: "timeline", labelKey: "tabs.timeline", Icon: ClockIcon },
